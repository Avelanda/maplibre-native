...
* If the "before" and "after" of two immutable references refers to the same object, we know that it hasn't changed. Whereas, if they're different, we know it has changed in some way.
